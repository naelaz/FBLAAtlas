...
export async function seedSchoolDataForUser(user: UserProfile): Promise<void> {
  const seedRef = doc(db, "app_meta", `seed_${user.schoolId}_v3`);
  ...
  const demoUsers: UserProfile[] = [
    ...
    },
    {
      ...
      primaryEvent: "Business Plan",
      followerIds: [],
      followingIds: [],
      bio: "Business plan competition finalist. Chapter president.",
      pointsByAction: {},
      lastLoginDate: null,
      lastDailyLoginDate: null,
      createdAt: new Date().toISOString(),
    ...
    },
    {
      ...
      followerIds: [],
      followingIds: [],
      bio: "Marketing and social media enthusiast.",
      pointsByAction: {},
      lastLoginDate: null,
      lastDailyLoginDate: null,
      createdAt: new Date().toISOString(),
    ...
    },
    {
      ...
      xp: 88,
      tier: "Bronze" as UserProfile["tier"],
      primaryEvent: "Digital Video Production",
      followerIds: [],
      followingIds: [],
      bio: "Video editor and storyteller.",
      pointsByAction: {},
      lastLoginDate: null,
      lastDailyLoginDate: null,
      createdAt: new Date().toISOString(),
    ...
    },
    {
      ...
      followerIds: [],
      followingIds: [],
      bio: "Three-time SLC qualifier. Public Speaking is my thing.",
      pointsByAction: {},
      lastLoginDate: null,
      lastDailyLoginDate: null,
      createdAt: new Date().toISOString(),
    ...
    },
    {
      ...
      xp: 130,
      tier: "Silver" as UserProfile["tier"],
      primaryEvent: "Graphic Design",
      followerIds: [],
      followingIds: [],
      bio: "Graphic design and visual storytelling.",
      pointsByAction: {},
      lastLoginDate: null,
      lastDailyLoginDate: null,
      createdAt: new Date().toISOString(),
    ...
    {
      ...user,
      displayName: "Skyler H.",
      uid: "demo_skyler_h",
      grade: "9",
      xp: 45,
      tier: "Bronze" as UserProfile["tier"],
      primaryEvent: "Introduction to FBLA",
      followerIds: [],
      followingIds: [],
      bio: "New member, excited to compete!",
      pointsByAction: {},
      lastLoginDate: null,
      lastDailyLoginDate: null,
      createdAt: new Date().toISOString(),
    ...
    },
    {
      ...
      primaryEvent: "Accounting",
      followerIds: [],
      followingIds: [],
      bio: "Chapter treasurer. Accounting and finance are my lane.",
      pointsByAction: {},
      lastLoginDate: null,
      lastDailyLoginDate: null,
      createdAt: new Date().toISOString(),
    ...
    },
    {
      ...
      xp: 175,
      tier: "Silver" as UserProfile["tier"],
      primaryEvent: "Cybersecurity",
      followerIds: [],
      followingIds: [],
      bio: "Into cybersecurity and networking. Future IT professional.",
      pointsByAction: {},
      lastLoginDate: null,
      lastDailyLoginDate: null,
      createdAt: new Date().toISOString(),
    ...
    },
    {
      ...
      followerIds: [],
      followingIds: [],
      bio: "Building my first startup while in high school.",
      pointsByAction: {},
      lastLoginDate: null,
      lastDailyLoginDate: null,
      createdAt: new Date().toISOString(),
